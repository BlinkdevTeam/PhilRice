        ...
        <div className="flex flex-col">
          ...
          <div className="w-full max-w-[1005px] px-6 order-last sm:order-none mt-4 sm:mt-0">
            ...
            <div className="text-[13px] md:text-[18px] lg:text-[22px] leading-relaxed">
              ...
              uplift the well-being of farming communities, foster a resilient
              ...
              <br /> <br />
              At the core of the Plan are three strategic pillars: scaling up
              innovations, advancing digital transformation, and fostering
              inclusive partnerships. These pillars serve as a foundation for
              modernizing rice farming and are seamlessly aligned with the
              Department of Agriculture’s roadmap, Para sa Masaganang Bagong
              Pilipinas. By leveraging these priorities, DA-PhilRice aims to
              strengthen the integration of research, development, and extension
              (R4DE) to provide solutions that are responsive to the needs of
              Filipino farmers and consumers.
              <br /> <br />
              Through the effective implementation of advanced rice science and
              technology, DA-PhilRice seeks to transform the rice farming sector
              into a robust and future-ready industry. This transformation is
              envisioned to contribute significantly to the country’s
              agricultural development goals while ensuring sustainability and
              resilience amidst evolving challenges. The Plan reaffirms
              DA-PhilRice’s commitment to its mission of empowering farmers,
              strengthening communities, and supporting the nation’s pursuit of
