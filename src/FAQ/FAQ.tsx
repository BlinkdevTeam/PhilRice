...
export default function FAQ() {
  ...
  return (
    <div className="flex flex-col justify-center items-center mb-16 px-4 sm:px-4 lg:px-12">
      <div className="text-[#0E9046] text-[40px] md:text-[50px] lg:text-[60px] font-bold text-center">
          ...
          >
            ...
            >
              <div className="flex flex-row items-center">
                ...
                <div className="ml-2 pr-8">{item.question}</div>
              </div>
              <span>
                {openIndex === index ? (
                  <div className="-rotate-180 transition-transform duration-300 ease-in-out">
                    ...
                    >
                      <path
                        d="M2 1.62012L10 9.5489L18 1.62012"
                        stroke="#FFFFFF"
                        stroke-width="3"
            ...
            >
              <div className="p-4 text-white bg-[#0E9046] rounded-b-lg text-[13px] md:text-[18px] lg:text-[22px] ps-10 pe-8">
                {item.answer}
                {item.link && (
                  <a
                    href={item.link}
