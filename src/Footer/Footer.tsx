    ...
    <>
      <div className="stick bottom-0 left-0">
        <div className="flex flex-col lg:flex-row lg:gap-24 justify-center w-screen bg-[#0C6972] px-4 md:px-8 lg:px-16 xl:px-32 py-12 relative">
          ...
          <div
            className="border-white border-2 rounded-full flex justify-center items-center w-[33px] h-[33px] md:w-[53px] md:h-[53px] lg:w-[56px] lg:h-[56px] p-2 absolute top-[60%] right-5 md:top-[65%] md:right-5 lg:top-32 lg:right-10"
