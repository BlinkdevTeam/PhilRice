...
import "../Speaker/speakerpage.css";
    ...
    <div
      ...
      <div className="relative bg-white flex mt-40 md:mt-0 flex-col md:flex-row rounded-tr-[80px] shadow-lg w-[298px] md:w-[90%] h-[450px] md:h-[374px] lg:h-[518px]">
        ...
        <div className="flex flex-wrap">
          <div className="w-[299px] md:w-[353px] lg:w-[449px] h-[356px] md:h-[366px] lg:h-[518px] bg-gr-custom-gradient rounded-tr-[100px] relative -mt-40 md:mt-2 lg:mt-0">
            <img
              src={speaker.image}
              alt={speaker.name}
              className="absolute bottom-16 w-full h-auto rounded-bl-[20px] fade-bottom"
            />
            {/* <div className="absolute bottom-28 md:bottom-36 left-0 w-40 h-2 bg-[#EFB71E]" /> */}
            <div className="absolute text-[15px] md:text-[22px] bottom-0 flex flex-col justify-center items-center text-center text-white bg-yel-custom-gradient w-full h-[155.64px] md:h-[247px] rounded-bl-[80px] px-2 fade-top">
              <div
