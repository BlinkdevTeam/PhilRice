    ...
    <div className="min-h-screen px-9 flex items-center justify-center">
      <div className="flex flex-wrap justify-center gap-4">
        {speakersData.map((speaker, index) => (
          <div
            key={index}
            className="w-[299px] md:w-[449px] h-[370px] md:h-[518px] bg-custom-gradient rounded-tr-[100px] relative mt-14 md:mt-20 lg:mt-20 cursor-pointer" // Add cursor-pointer for better UX
