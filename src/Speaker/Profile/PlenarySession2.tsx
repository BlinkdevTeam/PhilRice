...
const speakersData = [
  {
    ...
    title: "RCEF Achievements and Initial Impact on the Rice Industry",
    content:
  ...
  },
  {
    ...
    title:
      "Unpacking Assumptions, Processes, and Outcomes: An Independent Evaluation of Key Service Delivery Mechanisms in RCEF Implementation",
    content:
